...
export default function GameBrandsSection() {
    return (
        <section className="w-full bg-[#0a0a14] py-16 relative overflow-hidden border-t border-[#ffffff]/5">
            ...
            <div className="max-w-full mx-auto px-6 sm:px-8 lg:px-12 relative z-10">
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-8">
                    {brands.map((brand) => (
                        <div
                            key={brand.id}
                            className="group flex items-center justify-center p-6 bg-[#1a1a2e]/30 border border-[#ffffff]/5 hover:border-[#00d9ff]/30 rounded-xl transition-all duration-300 hover:bg-[#1a1a2e]/50 cursor-pointer"
                        >
                            <div className="relative w-full h-12 flex items-center justify-center">
                                ...
                                <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                                    <div className="absolute inset-0 bg-gradient-to-r from-[#00d9ff]/10 to-[#ff6b9d]/10 blur-xl" />
                                </div>
                            </div>
                        </div>
                    ))}
